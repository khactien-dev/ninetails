  ...
  return {
    ...
    components: {
      Layout: {
        ...
        bodyBg: currentTheme.layoutBodyBg,
        headerBg: currentTheme.layoutSiderBg,
        siderBg: currentTheme.layoutSiderBg,
      },
      Alert: {
        colorInfoBg: '#dfefff',
      ...
      Select: {
        ...
        controlItemBgActive: antTheme.primary1,
        controlItemBgHover: currentTheme.itemHoverBg,
        colorBgTextActive: currentTheme.primary,
      },
      Steps: {
        wireframe: true,
      ...
      Form: {
        marginLG: 16,
        colorInfoBorderHover: currentTheme.primary,
      },
      Avatar: {
      ...
      Button: {
        colorPrimary: currentTheme.primary,
        colorLinkHover: currentTheme.primary,
        colorPrimaryHover: currentTheme.primary,
        controlOutlineWidth: 0,
      },
      Breadcrumb: {
